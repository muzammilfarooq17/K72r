        ...
        <div className="flex w-full justify-between items-center">
          <div>
            <svg
              ...
              className="w-[80px] h-[32px] md:w-[130px] md:h-[50px] cursor-pointer"
              viewBox="0 0 103 44"
            >
          ...
          <div
            onClick={() => setNavOpen(false)}
            className="h-12 w-12 md:h-16 md:w-16 relative flex items-center justify-center cursor-pointer group"
          >
            <svg
              className="w-full h-full text-white stroke-current transition-transform duration-300 group-hover:rotate-90"
              viewBox="0 0 100 100"
              fill="none"
              strokeWidth="4"
            >
          ...
          <a href="/Work" className="link border-y border-gray-700 relative block cursor-pointer overflow-hidden py-3 md:py-6">
            ...
            <div className="movelink absolute flex top-0 left-0 text-black bg-[#d2f54c] w-full h-full pointer-events-none">
              <div className="moveX flex items-center gap-4 md:gap-6 h-full">
                <h2 className="whitespace-nowrap font-sans font-medium text-center text-[3.5rem] sm:text-[5rem] md:text-[7rem] lg:text-[9rem] tracking-tight leading-[0.8] uppercase m-0">
                  see everything
                </h2>
          ...
          <a href="/Contacts" className="link border-b border-gray-700 relative block cursor-pointer overflow-hidden py-3 md:py-6">
            ...
            <div className="movelink absolute flex top-0 left-0 text-black bg-[#d2f54c] w-full h-full pointer-events-none">
              <div className="moveX flex items-center gap-4 md:gap-6 h-full">
                ...
                <svg className="h-10 md:h-[5rem] w-auto fill-current shrink-0 self-center mx-4" viewBox="0 0 24 24">
